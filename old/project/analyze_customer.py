...
def load_models():
    ...
    try:
        ...
        return kmeans, scaler, gender_encoder, category_encoder, features
...
def predict_customer_segment():
    ...
    models = load_models()
    if None in models:
        print("Vui lòng huấn luyện mô hình trước khi dự đoán!")
        return
        
    kmeans, scaler, gender_encoder, category_encoder, features = models
    ...
    try:
        ...
        print(f"Có lỗi xảy ra trong quá trình dự đoán: {str(e)}")

def main():
    while True:
        print("\n=== CHƯƠNG TRÌNH DỰ ĐOÁN PHÂN KHÚC KHÁCH HÀNG ===")
        print("1. Dự đoán phân khúc khách hàng mới")
        print("2. Thoát")
        
        choice = input("\nVui lòng chọn chức năng (1-2): ")
